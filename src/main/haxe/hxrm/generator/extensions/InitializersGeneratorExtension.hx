...
class InitializersGeneratorExtension extends GeneratorExtensionBase {
    ...
    function parseFieldInitializator(context : HxmrContext, scope : GeneratorScope, initializator : {name : String, type : Type}) : Void {

        var fieldComplexType : ComplexType = Context.toComplexType(initializator.type);
